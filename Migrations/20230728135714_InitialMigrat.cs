        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrojRemija = table.Column<int>(type: "int", nullable: false),
                    BrojOsvojenihBodovaNaTurniru = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Timovi_Turniri_TurnirId",
                        column: x => x.TurnirId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimModelId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Igraci_Timovi_TimModelId",
                        column: x => x.TimModelId,
                        principalTable: "Timovi",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Tim_1_Id = table.Column<int>(type: "int", nullable: false),
                    Tim_2_Id = table.Column<int>(type: "int", nullable: false),
                    Tim_1_BrojGolova = table.Column<int>(type: "int", nullable: false),
                    Tim_2_BrojGolova = table.Column<int>(type: "int", nullable: false),
                    ...
                    Tim_1_Ime = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Tim_2_Ime = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rezultati", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Rezultati_Turniri_TurnirId",
                        column: x => x.TurnirId,
                        principalTable: "Turniri",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Igraci_TimModelId",
                table: "Igraci",
                column: "TimModelId");

            migrationBuilder.CreateIndex(
                name: "IX_Rezultati_Tim1Id",
                table: "Rezultati",
                column: "Tim1Id");

            migrationBuilder.CreateIndex(
                name: "IX_Rezultati_Tim2Id",
                table: "Rezultati",
                column: "Tim2Id");

            migrationBuilder.CreateIndex(
                name: "IX_Rezultati_TurnirId",
                table: "Rezultati",
                column: "TurnirId");

            migrationBuilder.CreateIndex(
                name: "IX_Timovi_TurnirId",
                table: "Timovi",
                column: "TurnirId");
        }
